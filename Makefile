...
help:
	...
	@echo "  Small (4x4):   Best=5 vazias (31%)  | Worst=8 vazias (50%)"
	@echo "  Medium (9x9):  Best=24 vazias (30%) | Worst=40 vazias (49%)"
	@echo "  Large (16x16): Best=77 vazias (30%) | Worst=128 vazias (50%)"
	@echo ""
